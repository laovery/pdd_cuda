function [SE,R_u,R_d,I_SI,I_user]=FD_NRU(user_num,n_BS,RF,beta,alphe,temp)    
    %% parameter setup===========================================================
    %clc;
    %clear;
    ...
    y_BS=0;
    m_BS=n_BS;
    %m_BS=16;n_BS=16;RF=8;user_num=16;beta=50;
...
%     hold off;
    ...
    H_SI=sqrt(10^(-beta/10))*mmWave_matrix(n_BS,m_BS);
...
%    SE3=0;
%     SE=[SE2,SE3,SE4,SE5];     
%     R_u=[R_u1,R_u2,R_u3,R_u4,R_u5];
%     R_d=[R_d1,R_d2,R_d3,R_d4,R_d5];
    %% stimulation result
%     figure(2)
%     x=1:length(q);
%     plot(x,real(q),'ko-');
